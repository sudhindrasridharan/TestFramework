Documentation     This robot file consist of different locators of firstAlert android application.

*** Settings ***
Resource        ../CommonClass.robot

*** Variables ***
${parent}	com.gto.gtoaccess:id
${id}		diya.chudasama@volansystech.com
${code}		test123
${signInX}	539
${signInY}	779
